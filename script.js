    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            inputs.forEach(input => {
                ...
                const validator = validators[input.name] || validators[input.id];
                if (validator) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (input.closest('input, textarea, select')) {
                clearError(input);
            }
        });
    }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '31971778-5506-44d8-bdba-de4740a8df50',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '31971778-5506-44d8-bdba-de4740a8df50';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '31971778-5506-44d8-bdba-de4740a8df50';
